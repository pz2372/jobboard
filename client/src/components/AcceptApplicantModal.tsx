...
import { XIcon, AlertTriangleIcon, CheckIcon } from "lucide-react";
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="text-sm text-gray-600">
              <p className="font-medium text-gray-900 mb-2">
                Important: Only one applicant can be accepted per job posting.
              </p>
              <p>
                When you accept <span className="font-medium">{applicantName}</span> for{" "}
                <span className="font-medium">"{jobTitle}"</span>, the job posting will be automatically closed and no other applicants can be accepted.
              </p>
            </div>
          </div>
        </div>
