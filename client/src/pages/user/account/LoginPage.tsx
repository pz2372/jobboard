...
import { setAppliedJobs, setSavedJobs } from "../../../redux/historySlice";
...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Update Redux state (Redux Persist will automatically save to localStorage)
      dispatch(setUserProfile(response.userProfile));
      dispatch(setAppliedJobs(response.appliedJobs));
