...
const JobSuccess = ({ jobData }: any) => {
    return (<div className="w-full min-h-screen bg-gray-50 px-4 py-8">
        <div className="max-w-3xl mx-auto mt-16">
          ...
          <div className="mb-8">
            <div className="max-w-xl mx-auto bg-white rounded-xl shadow-sm p-8 border-2 border-transparent hover:border-teal-500 cursor-pointer transition-all">
